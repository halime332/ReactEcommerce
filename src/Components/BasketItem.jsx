...
const BasketItem = ({ item }) => {
    ...
    return (
        <div className="d-flex flex-column flex-md-row gapa-3
        align-items-md-center justify-content-between border-bottom pb-4">
            ...
            <div className="d-flex justify-content-between align-items-center gap-3">
                ...
                <div className="d-flex gap-2">
                    <button onClick={() => removeFromBasket(item.id)} className="btn btn-danger button">{item.amount === 1 ? <FaTrashAlt /> : "-"}</button>
